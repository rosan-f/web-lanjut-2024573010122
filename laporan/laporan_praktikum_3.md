...
* **resources/view/greet.blade.php**  
  ![Gambar](gambar/praktukum_3/greet-view.png)

* **resources/view/hello.blade.php**  
  ![Gambar](gambar/praktukum_3/hello-view.png)

* **resources/view/search.blade.php**  
  ![Gambar](gambar/praktukum_3/search-view.png)
...
![Gambar](gambar/praktukum_3/page-controller.png)  
...
![Gambar](gambar/praktukum_3/lab-group-route.png)  
...
* **resources/views/pages/home.blade.php**  
  ![Gambar](gambar/praktukum_3/home-view.png)  

* **resources/views/pages/about.blade.php**  
  ![Gambar](gambar/praktukum_3/about-view.png)  

* **resources/views/pages/contact.blade.php**  
  ![Gambar](gambar/praktukum_3/contact-view.png)  
...
* **[http://127.0.0.1:8000/](http://127.0.0.1:8000/)** *(Home)*  
  ![Gambar](gambar/praktukum_3/home-result.png)

* **[http://127.0.0.1:8000/about](http://127.0.0.1:8000/about)** *(About)*  
  ![Gambar](gambar/praktukum_3/about-result.png)

* **[http://127.0.0.1:8000/contact](http://127.0.0.1:8000/contact)** *(Contact)*  
  ![Gambar](gambar/praktukum_3/contact-result.png)
...
* **App/Http/Controllers/Admin/DashboardController.php**  
  ![Gambar](gambar/praktukum_3/dashboard-controller.png)  
  Controller ini memiliki satu metode yang mengembalikan *message* ke *view*.

* **App/Http/Controllers/Admin/UserController.php**  
  ![Gambar](gambar/praktukum_3/user-controller.png)  
...
![Gambar](gambar/praktukum_3/lab-prefix-route.png)  
...
* **resources/views/dashboard.blade.php**  
  ![Gambar](gambar/praktukum_3/dashboard-view.png)  

* **resources/views/admin/users/index.blade.php**  
  ![Gambar](gambar/praktukum_3/user-index-view.png)  

* **resources/views/admin/users/show.blade.php**  
  ![Gambar](gambar/praktukum_3/user-show-view.png)  
...
* **[http://127.0.0.1:8000/admin/dashboard](http://127.0.0.1:8000/admin/dashboard)**    
  ![Gambar](gambar/praktukum_3/dashboard-result.png)  

* **[http://127.0.0.1:8000/admin/users](http://127.0.0.1:8000/admin/users)**    
  ![Gambar](gambar/praktukum_3/user-index-result.png)  

* **[http://127.0.0.1:8000/admin/users/1](http://127.0.0.1:8000/admin/users/1)**    
  ![Gambar](gambar/praktukum_3/user-show-result.png)  
